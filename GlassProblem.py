...
for i in range(70-17):
	df=df.append(help1)
for i in range(70-13):
	df=df.append(help2)
for i in range(70-9):
	df=df.append(help3)
for i in range(70-29):
	df=df.append(help4)
print (df.describe())
...
#Feature extraction:
# pcaExtractor=PCA(n_components=7)
...
#KNN
knnSimpleClf=KNeighborsClassifier(n_neighbors=18)
# knnSimpleClf=KNeighborsClassifier()
